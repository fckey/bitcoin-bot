...
public class Board {
    ...
    public Board(int midPrice, List<Order> bids, List<Order> asks) {
    ...
    @JsonCreator
    public static Board build(@JsonProperty("mid_price")int midPrice,
    ...
    public static class Order {
        ...
        public Order(int price, double size) {
            this.price = price;
            this.size = size;
        }
        ...
        @JsonCreator
        public static Order build(@JsonProperty("price")int price,
